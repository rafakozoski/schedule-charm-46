...
export default function PetShopPage() {
  return (
    <SegmentLPTemplate
      nichoTitle="Pet Shops"
      nichoShort="o seu Pet Shop"
      ...
      imageUrl="https://loremflickr.com/800/600/pet-shop?lock=1"
      imageAlt="Foto representativa para Pet Shops"
      benefits={[
        {
          icon: CalendarClock,
        ...
        },
        {
          ...
          desc: "Seu perfil aparece para novos clientes da sua área que estão buscando por pet shops."
        },
        {
          icon: Users,
