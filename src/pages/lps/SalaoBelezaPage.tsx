...
export default function SalaoBelezaPage() {
  return (
    <SegmentLPTemplate
      nichoTitle="Salões de Beleza"
      nichoShort="o seu Salão de Beleza"
      ...
      imageUrl="https://loremflickr.com/800/600/beauty-salon?lock=1"
      imageAlt="Foto representativa para Salões de Beleza"
      benefits={[
        {
          icon: CalendarClock,
        ...
        },
        {
          ...
          desc: "Seu perfil aparece para novos clientes da sua área que estão buscando por salões de beleza."
        },
        {
          icon: Users,
