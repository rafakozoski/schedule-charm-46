...
export default function ProfessorParticularPage() {
  return (
    <SegmentLPTemplate
      nichoTitle="Professores Particulares"
      nichoShort="as suas Aulas"
      ...
      imageUrl="https://loremflickr.com/800/600/tutor?lock=1"
      imageAlt="Foto representativa para Professores Particulares"
      benefits={[
        {
          icon: CalendarClock,
        ...
        },
        {
          ...
          desc: "Seu perfil aparece para novos clientes da sua área que estão buscando por professores particulares."
        },
        {
          icon: Users,
