...
export default function AutoEscolaPage() {
  return (
    <SegmentLPTemplate
      nichoTitle="Autoescolas"
      nichoShort="a frota e as aulas da sua Autoescola"
      ...
      imageUrl="https://loremflickr.com/800/600/driving-school?lock=1"
      imageAlt="Foto representativa para Autoescolas"
      benefits={[
        {
          icon: CalendarClock,
        ...
        },
        {
          ...
          desc: "Seu perfil aparece para novos clientes da sua área que estão buscando por autoescolas."
        },
        {
          icon: Users,
