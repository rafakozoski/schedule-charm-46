...
export default function EsteticaAutomotivaPage() {
  return (
    <SegmentLPTemplate
      nichoTitle="Estética Automotiva"
      nichoShort="o seu espaço de Estética Automotiva"
      ...
      imageUrl="https://loremflickr.com/800/600/auto-detailing?lock=1"
      imageAlt="Foto representativa para Estética Automotiva"
      benefits={[
        {
          icon: CalendarClock,
        ...
        },
        {
          ...
          desc: "Seu perfil aparece para novos clientes da sua área que estão buscando por estética automotiva."
        },
        {
          icon: Users,
