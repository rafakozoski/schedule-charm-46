...
export default function ConsultorPage() {
  return (
    <SegmentLPTemplate
      nichoTitle="Consultores"
      nichoShort="a sua Consultoria"
      ...
      imageUrl="https://loremflickr.com/800/600/consulting?lock=1"
      imageAlt="Foto representativa para Consultores"
      benefits={[
        {
          icon: CalendarClock,
        ...
        },
        {
          ...
          desc: "Seu perfil aparece para novos clientes da sua área que estão buscando por consultores."
        },
        {
          icon: Users,
