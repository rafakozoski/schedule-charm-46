...
export default function PsicologoPage() {
  return (
    <SegmentLPTemplate
      nichoTitle="Psicólogos"
      nichoShort="o seu Consultório de Psicologia"
      ...
      imageUrl="https://loremflickr.com/800/600/psychologist?lock=1"
      imageAlt="Foto representativa para Psicólogos"
      benefits={[
        {
          icon: CalendarClock,
        ...
        },
        {
          ...
          desc: "Seu perfil aparece para novos clientes da sua área que estão buscando por psicólogos."
        },
        {
          icon: Users,
