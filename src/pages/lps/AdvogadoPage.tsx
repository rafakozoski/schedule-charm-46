...
export default function AdvogadoPage() {
  return (
    <SegmentLPTemplate
      nichoTitle="Advogados e Escritórios"
      nichoShort="o seu Escritório de Advocacia"
      ...
      imageUrl="https://loremflickr.com/800/600/lawyer?lock=1"
      imageAlt="Foto representativa para Advogados e Escritórios"
      benefits={[
        {
          icon: CalendarClock,
        ...
        },
        {
          ...
          desc: "Seu perfil aparece para novos clientes da sua área que estão buscando por advogados e escritórios."
        },
        {
          icon: Users,
