...
export default function FonoaudiologoPage() {
  return (
    <SegmentLPTemplate
      nichoTitle="Fonoaudiólogos"
      nichoShort="a sua Fonoaudiologia"
      ...
      imageUrl="https://loremflickr.com/800/600/speech-therapist?lock=1"
      imageAlt="Foto representativa para Fonoaudiólogos"
      benefits={[
        {
          icon: CalendarClock,
        ...
        },
        {
          ...
          desc: "Seu perfil aparece para novos clientes da sua área que estão buscando por fonoaudiólogos."
        },
        {
          icon: Users,
