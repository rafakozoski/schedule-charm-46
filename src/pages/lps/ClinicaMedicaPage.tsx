...
export default function ClinicaMedicaPage() {
  return (
    <SegmentLPTemplate
      nichoTitle="Clínicas Médicas"
      nichoShort="a sua Clínica"
      ...
      imageUrl="https://loremflickr.com/800/600/medical-clinic?lock=1"
      imageAlt="Foto representativa para Clínicas Médicas"
      benefits={[
        {
          icon: CalendarClock,
        ...
        },
        {
          ...
          desc: "Seu perfil aparece para novos clientes da sua área que estão buscando por clínicas médicas."
        },
        {
          icon: Users,
