...
export default function DogWalkerPage() {
  return (
    <SegmentLPTemplate
      nichoTitle="Dog Walkers"
      nichoShort="os seus passeios"
      ...
      imageUrl="https://loremflickr.com/800/600/dog-walker?lock=1"
      imageAlt="Foto representativa para Dog Walkers"
      benefits={[
        {
          icon: CalendarClock,
        ...
        },
        {
          ...
          desc: "Seu perfil aparece para novos clientes da sua área que estão buscando por dog walkers."
        },
        {
          icon: Users,
