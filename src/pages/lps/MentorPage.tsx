...
export default function MentorPage() {
  return (
    <SegmentLPTemplate
      ...
      imageUrl="https://loremflickr.com/800/600/mentoring?lock=1"
      imageAlt="Foto representativa para Mentores"
      benefits={[
        {
          icon: CalendarClock,
        ...
        },
        {
          ...
          desc: "Seu perfil aparece para novos clientes da sua área que estão buscando por mentores."
        },
        {
          icon: Users,
